...
```
> pollination-apps run app mikkel --name "Design Explorer"
```

## Deploy to Pollination

```
> pollination-apps deploy app --name "Design Explorer" --sdk dash --public --api-token "Your api token from Pollination"
```
...
Github actions will then package and deploy your code to an app called [Design Explorer](https://app.pollination.cloud/mikkel/applications/design-explorer)
